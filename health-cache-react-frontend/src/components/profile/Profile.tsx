...
const _Profile: React.FC<ProfileProps> = (props) => {
  ...
  const [addressLineOne, setAddressLineOne] = useState(
    appState.userLogin.addressLineOne
  );
  const [addressLineTwo, setAddressLineTwo] = useState(
    appState.userLogin.addressLineTwo
  );
  ...
  const [relationshipStatus, setRelationshipStatus] = useState(
    appState.userLogin.relationshipStatus
  );
  ...
  const renderPic = (): string => {
    ...
    if (profilePic === null || profilePic === "") {
      return "http://healthcache.s3-website-us-east-1.amazonaws.com/1638305177139_default-profile-pic.jpg"; //replace URLs with HealthCache S3 url
    } else {
      return (
        "http://healthcache.s3-website-us-east-1.amazonaws.com/" + profilePic
      );
    }
  };
  ...
  const updateUser = async (e: any) => {
    ...
    let user: User = {
      ...
      profpic: profilePic,
      relationshipStatus,
      role: appState.userLogin.role,
      user_id: appState.userLogin.user_id,
      username,
      zipcode,
    };
    const resp = await axios.put<User>(
      `/api/profile/update/${appState.userLogin.user_id}`,
      user
    );
  ...
  const imageHandler = async (e: any) => {
    ...
    const apiRespose = await axios.post("api/file/upload", data);
  ...
  return (
    <section>
      <div
        ...
        className="container text-black rounded bg-secondary3 rounded mt-5 mb-5 text-primary3"
      >
          ...
          <div className="col-md-5 border-right">
            <div className="p-3 py-5">
              <div className="d-flex justify-content-between align-items-center mb-3">
                ...
                <Button
                  className={"center bg-primary border-primary text-primary2"}
              ...
              {editMode ? (
                <section>
                  ...
                  <div className="row mt-3">
                    ...
                    <div className="col-md-12">
                      <label className="labels">Relationship Status</label>
                      <input
                        type="text"
                        className="form-control"
